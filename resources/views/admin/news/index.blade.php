        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="pull-right" style="margin-bottom: 5px;margin-top: 0;" >
                    <a href="{{route('admin.news.create')}}" class="btn btn-default btn-lg"><span class="glyphicon glyphicon-pencil"></span></a>
                </div>
                    ...
                    @foreach($news as $new)
                        <div class="col-md-4">
                            <div class="thumbnail content-box">
                                <img src="{{URL::to('img/uploads/admin/news/'.$new->picture)}}" alt="">
                                <h4><strong>{{$new->title}}</strong></h4>
                                <p>{{$new->body}}</p>
                                <div>
                                    <a href="{{route('admin.news.edit',['news_id'=> $new->id])}}" class="btn btn-success"><i class="glyphicon glyphicon-edit"></i></a>
                                    <a  href="{{route('news.delete',['news_id'=>$new->id])}}" class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i></a>
                                </div>
                            </div>
                        </div>
                    @endforeach

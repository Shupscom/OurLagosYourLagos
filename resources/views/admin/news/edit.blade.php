            ...
            <div class="col-md-10">
                <div class="row">
                    <div class="col-md-8 content-box">
                        <h3>Edit {{$new->title}}</h3>
                        <form action="{{route('news.edit')}}" method="post" enctype="multipart/form-data">
                            <div class="form-group {{ $errors->has('title') ? ' has-error' : '' }}">
                                <label for="title">Title</label>
                                <input class="form-control" type="text" name="title" id="title" placeholder="Title" value="{{$new->title}}"/>
                                @if ($errors->has('title'))
                            ...
                            <div class="form-group{{ $errors->has('body') ? ' has-error' : '' }}">
                                ...
                                <textarea class="form-control" name="body" id="body" rows="10" {{$errors->has('body') ? 'class=has-error' : ''}}>{{$new->body}}</textarea>
                                @if ($errors->has('body'))
                                    <span class="help-block">
                            ...
                            <div class="form-group{{ $errors->has('author') ? ' has-error' : '' }}">
                                ...
                                <input class="form-control" type="text" name="author" id="author" placeholder="Author" value="{{$new->author}}"/>

        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="pull-right" style="margin-bottom: 5px;margin-top: 0;" >
                    <a href="{{route('blogger.create')}}" class="btn btn-default btn-lg"><span class="glyphicon glyphicon-pencil"></span></a>
                </div>
                    ...
                    @foreach($posts as $post)
                        <div class="col-md-4">
                            <div class="thumbnail content-box">
                                ...
                                <div>
                                    <a href="{{route('blogger.modify',['post_id' => $post->id,'post_title' => $post->title])}}" class="btn btn-success"><i class="glyphicon glyphicon-edit"></i></a>
